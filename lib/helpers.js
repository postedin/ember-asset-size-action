...
function reportTable(data) {
  let table = `File | raw | gzip | brotoli
--- | --- | --- | ---
`;
  data.forEach((item) => {
    const row = ['raw', 'gzip', 'brotoli'].map((type) => {
