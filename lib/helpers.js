...
export async function installDependencies() {
  if (fs.existsSync('resources/assets/yarn.lock')) {
    exec('pwd', {cwd: 'resources/assets'})
    return exec('yarn --frozen-lockfile', {cwd: 'resources/assets'});
  }
...
export async function getAssetSizes() {
  ...
  await exec('npx ember build -prod --output-path ../../dist', {cwd: 'resources/assets'});
